"""
Refactored plotting functions for the ionerdss package.
These functions use the centralized data reading functionality.
"""
...
# The remaining plotting functions would be refactored in a similar way
# Each function should use the DataIO class for data access
# For brevity, I'm showing only the most important functions here
# In a real implementation, all functions would be refactored similarly