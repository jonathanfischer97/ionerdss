...
def plot_line_speciescopy_vs_time(
    ...
    all_sim_data = DataIO.get_multiple_copy_numbers(selected_dirs)
...
def plot_line_maximum_assembly_size_vs_time(
    ...
    for sim_dir in selected_dirs:
        data = DataIO.get_histogram_complexes(sim_dir)
...
def plot_line_free_energy(
    ...
    for sim_dir in selected_dirs:
        matrix, _ = DataIO.get_transition_matrix(sim_dir, time_frame)
        if matrix is None:
            continue
