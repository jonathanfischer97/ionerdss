...
# Lazily load core classes using a mapping to reduce repetition
_lazy_map = {
    ...
    'ReactionStringParser': ('.ode.reaction_string_parser', 'ReactionStringParser'),
    'solve_reaction_ode': ('.ode.reaction_ode_solver', 'solve_reaction_ode'),
    'reaction_dydt': ('.ode.reaction_ode_solver', 'dydt'),
    'calculate_macroscopic_reaction_rates': ('.ode.reaction_ode_solver', 'calculate_macroscopic_reaction_rates'),
    'SimpleGillespieSimulator': ('.gillespie.simple_gillespie', 'SimpleGillespieSimulator'),
    'gui': ('.gui.gui', 'gui'),
    'pdb_gui': ('.gui.nerdss', 'nerdss'),
    ...
    'convert_simularium': ('.converter.simularium_converter', 'convert_simularium'),
    'Simulation': ('.simulation.simulation', 'Simulation'),
    'Analysis': ('.analysis.analysis', 'Analysis'),
    'DataIO': ('.analysis.data_readers', 'DataIO'),
}

for _name, (_module, _attr) in _lazy_map.items():
    globals()[_name] = LazyLoader(_module, _attr)

# Backward-compatible alias
ParseComplexes = globals()['generate_ode_model_from_pdb']
...
import syssys.modules[__name__].__class__ = type("ionerdss", (sys.modules[__name__].__class__, _ModuleProperties), {})
