...
from norm_check import norm_input
...
interaction = chain_int(unique_chain, split_position, split_resi_count, split_atom_count,
                ...
                while True:
                    ...
                    if new_distance >= 0:
                        ...
                        if n >= 0:
                            ...
                            unit_dir_vec1 = [
                                dir_vec1[0] / mag(dir_vec1), dir_vec1[1] / mag(dir_vec1), dir_vec1[2] / mag(dir_vec1)]
                            unit_dir_vec2 = [
                                dir_vec2[0] / mag(dir_vec2), dir_vec2[1] / mag(dir_vec2), dir_vec2[2] / mag(dir_vec2)]
...
while True:
    answer_norm = str(
        input("Would you like to self-generate norm vector? (Type 'yes' or 'no'): "))
